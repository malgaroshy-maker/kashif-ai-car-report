...
> هذا القسم كان مواصفة مقترحة قبل البناء، والمبني اختلف عنها عن قصد.
> **المرجع المعتمد الآن هو [DESIGN.md](DESIGN.md)**، وهو مكتوب من الكود نفسه،
> و`/design` يعرضه حياً. الملخّص:

- **الاتجاه والخطوط**:
  - الاتجاه: **RTL**، وبخصائص CSS منطقية بالكامل (`border-inline-start`,
    `ms-`, `ps-`) — ما فيش `left` ولا `right` في النظام.
  - النص: **Readex Pro** — عائلة متغيّرة عربية الأصل، مش خط لاتيني مركّب عليه
    عربي.
  - الأرقام والأكواد: **Azeret Mono**، للقيم المقيسة فقط (VIN، DTC، أرقام
    الوكالة، الفولتية)، مش كزينة "تقنية".

- **الألوان**: مش لوحة ألوان، بل **كود**: ISO/DIN 72581-3، نفس ألوان فيوزات
  السيارة اللي الأسطى يقراها أصلاً بدون ما نعلّمه إياها.

  | المستوى | الفيوز | الشكل المرسوم |
  |---|---|---|
  | حرج | 10A أحمر | مثلث |
  | متوسط | 20A أصفر | نصف شريط |
  | سليم | 30A أخضر | صح |
  | ذاكرة | 25A شفاف | حلقة |
  | تفاعلي (مش حالة) | 15A أزرق | — |

  **اللون وحده ما يحملش الخطورة أبداً** — لكل مستوى شكل مرسوم، لأن التقرير
  يُطبع أبيض وأسود ويقراه فنيون عندهم عمى ألوان.

- **العمق**: ضلع مصبوب (`.rib`) — أخدود غامق مع حافة مضيئة — مش ظل. في النظام
  كله **ظل واحد**، لخلية مسحوبة من اللوحة. ولا شيء دائري.

- **الوضعان**: الفاتح هو الافتراضي (المشهد: تلفون في شمس ليبيا)، والداكن
  مجموعة رموز منفصلة مش فلتر مقلوب. **صفر إخفاق تباين في الاثنين**، مقيسة على
  148 عقدة نص، والفحص يشتغل في CI.
