    ...
    <Sheet title="الفيوز والفيشة" onClose={onClose}>
      <div className="space-y-[var(--s5)]">
        ...
        <p className="rib pt-[var(--s3)] leading-relaxed text-(color:--ink-2)">
          ...
          مطبوعين على غطاء علبة الفيوزات في سيارتك — هذا هو المرجع الأكيد.
        </p>
      </div>
    </Sheet>
  );
...
> = {
  scan: {
    label: "من فحص سيارتك",
    note: "هذه البيانات مستخرجة من تقرير الفحص الخاص بهذه السيارة.",
    ink: "var(--amp-30-ink)",
  },
  reference: {
  ...
  general: {
    ...
    note: "الرمز مش موجود في المرجع عندنا. اللي تحت إرشاد ورشة عام لعائلة هذا الرمز: ما فيهش رقم فيوز ولا أمبير ولا موقع محدد، لأن دي تختلف من سيارة لسيارة.",
    ink: "var(--amp-10-ink)",
  },
};
